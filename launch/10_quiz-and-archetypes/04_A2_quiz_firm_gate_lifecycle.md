...
> GATE DECISION REVISED (Dana + Camila, 2026-07-18): **firm gate** — supersedes the July 16 "soft gate" decision everywhere it appears (older docs in `_source-plans/` still say soft; this file wins). File renamed accordingly (was `04_A2_quiz_soft_gate_lifecycle.md`).
