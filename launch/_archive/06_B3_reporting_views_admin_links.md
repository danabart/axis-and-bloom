...
> Order: 6 of 10 · Model: **Opus/Fable** (DB roles/permissions) · Depends on: Step 02 (quiz_funnel_event exists). After this step: assemble the Looker Studio report (manual) — dashboard must be live before the first real ad dollar.
