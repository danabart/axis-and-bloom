...
> Global step 11 of 11 · Workstream: ads-and-social · Model: Opus · Depends on: Step 05 (Mailchimp tags) + manual Meta setup (Facebook App, page token, webhook subscription) · Decision rule: skip entirely if click-to-site ads hit the $2–4 cost-per-subscriber target.
