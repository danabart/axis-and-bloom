...
> Global step 05 of 11 · Workstream: email-marketing · Model: Sonnet · Depends on: Step 04 (archetype data reaches the subscribe endpoint). After this step: build the Mailchimp Customer Journey (manual) — the July pipeline is then complete.
