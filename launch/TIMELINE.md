...
| M7 | Aug 8 | Pricing workshop → final price ($32–34 zone) → update admin slot-price matrix · fill Unit_Economics blue cells first (payment rails already decided: Stripe, 7/18) | root / `_source-plans/Unit_Economics.xlsx` | Dana + Camila | ⬜ |
