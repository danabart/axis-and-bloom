-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: Quiz V7 normalization
...
-- ─── 4. Drop old text-based quiz_branch, recreate normalized ─────────────────
DO $$ BEGIN
  IF EXISTS (
...
-- ─── 5. Re-seed V7 with normalized branch quiz structure ─────────────────────
DO $v7$
DECLARE
  v_main_type_id   UUID;
...
BEGIN
  ...
  INSERT INTO quiz_answer (question_id, answer_text, resulting_archetype_id) VALUES
    (v_fbq1_id, 'It''s complex and alive. A lot happening — I want to explore every sip.', v_fruit_id),
    (v_fbq1_id, 'It''s so light and delicate it barely feels like coffee. Almost like drinking tea.', v_floral_id);
  ...
  INSERT INTO quiz_answer (question_id, answer_text, resulting_archetype_id) VALUES
    (v_ebq1_id, 'Rich and comforting. Coffee that feels like a reward at the end of the day.', v_choc_id),
    (v_ebq1_id, 'Deep and intense. Complex, almost challenging. The more serious the better.', v_earthy_id);
