...
WHERE NOT EXISTS (
  ...
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Colombia' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Feather In Cap' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Crosshatch' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  ...
  WHERE archetype = 'chocolate_nutty'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Noam Blend' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  ...
  WHERE archetype = 'earthy'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Nocturnal Dark Roast' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'earthy'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Vantablack Ultra-Dark' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  ...
  WHERE archetype = 'floral'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Honduras' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  ...
  WHERE archetype = 'fruity'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Ethiopia' AND roaster = 'Path Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Breakfast Blend' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Blonde Blend' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Guatemala' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'balanced_sweet'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Colombia' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'chocolate_nutty'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Brazil Santos' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'chocolate_nutty'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'African Espresso Blend' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'chocolate_nutty'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = '6-Bean Espresso Blend' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'earthy'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Sumatra' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'earthy'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Bali Blue' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'earthy'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Uganda' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'floral'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Papua New Guinea' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'floral'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Ethiopia Natural' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'fruity'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Costa Rica' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'fruity'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Tanzania' AND roaster = 'Temecula Coffee Roasters')
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM dial_archetype_positions
  WHERE archetype = 'fruity'
    AND coffee_id = (SELECT MIN(id) FROM coffees WHERE name = 'Kenya' AND roaster = 'Temecula Coffee Roasters')
);
