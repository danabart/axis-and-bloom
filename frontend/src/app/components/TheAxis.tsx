...
function SplitVisual() {
  return (
    <svg viewBox="0 0 520 180" width="100%" style={{ display: 'block' }}>
      ...
      <text x="119" y="22" textAnchor="middle" fontSize={9} fontFamily="'Fashion Fetish',Arial,sans-serif" fill="rgba(0,0,0,0.35)" letterSpacing="0.1em">WHERE IT&apos;S FROM</text>
      ...
      <text x="119" y="165" textAnchor="middle" fontSize={9} fontFamily="'Fashion Fetish',Arial,sans-serif" fill="rgba(0,0,0,0.35)" fontStyle="italic">Origin · Season · Terroir</text>

      {/* Arrow */}
      <text x="260" y="97" textAnchor="middle" fontSize={18} fill="rgba(154,41,24,0.5)" fontFamily="'Fashion Fetish',Arial,sans-serif">→</text>

      {/* Right panel — flavor shape */}
      <rect x="282" y="0" width="238" height="180" rx="10" fill="rgba(154,41,24,0.05)" />
      <text x="401" y="22" textAnchor="middle" fontSize={9} fontFamily="'Fashion Fetish',Arial,sans-serif" fill="rgba(154,41,24,0.5)" letterSpacing="0.1em">WHAT IT ACTUALLY TASTES LIKE</text>
      {/* Radar polygon */}
      {(() => {
      ...
      <text x="401" y="165" textAnchor="middle" fontSize={9} fontFamily="'Fashion Fetish',Arial,sans-serif" fill="rgba(154,41,24,0.5)" fontStyle="italic">A precise, repeatable flavor signature</text>
    </svg>
  );
}
...
function FeedbackLoop() {
  ...
  return (
    <svg viewBox="0 0 400 290" width="100%" style={{ display: 'block' }}>
      ...
      {/* Center label */}
      <text x={cx} y={cy - 9} textAnchor="middle" fontSize={10} fontFamily="'Fashion Fetish',Arial,sans-serif" fill="rgba(0,0,0,0.4)">Refine your</text>
      <text x={cx} y={cy + 6} textAnchor="middle" fontSize={10} fontFamily="'Fashion Fetish',Arial,sans-serif" fill="rgba(0,0,0,0.4)">vector</text>
          ...
          <g key={i}>
            ...
            {lines.map((line, li) => (
              <text key={li}
                ...
                fontSize={9.5} fontFamily="'Fashion Fetish',Arial,sans-serif" fill={node.color}
              >
                {line}
              </text>
            ))}
...
export default function TheAxis() {
  return (
    <div style={{ fontFamily: "'Fashion Fetish', Arial, sans-serif", backgroundColor: '#f2f1ea', minHeight: '100vh' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div style={{ background: 'rgba(242,241,234,0.7)', borderRadius: 12, padding: '1.25rem' }}>
              ...
              <svg viewBox="0 0 440 280" width="100%" style={{ display: 'block' }}>
                ...
                <text x="278" y="111" fontSize="9" fontFamily="'Fashion Fetish',Arial,sans-serif" fill="#a33726" fillOpacity="0.7" letterSpacing=".07em">WHEELHOUSE</text>
                <text x="301" y="84" fontSize="9" fontFamily="'Fashion Fetish',Arial,sans-serif" fill="#c4821a" fillOpacity="0.65" letterSpacing=".07em">EXPLORING</text>
                ...
                <text x="92" y="73" fontSize="11" fill="#7a6a4f" fontFamily="'Fashion Fetish',Arial,sans-serif" fontWeight="500">Earthy</text>
                <circle cx="85" cy="228" r="9" fill="#a54c2d" />
                <text x="85" y="251" fontSize="10.5" fill="#a54c2d" fontFamily="'Fashion Fetish',Arial,sans-serif" textAnchor="middle">Choc. &amp; Nutty</text>
                <circle cx="153" cy="128" r="9" fill="#c9a830" />
                <text x="141" y="120" fontSize="10.5" fill="#c9a830" fontFamily="'Fashion Fetish',Arial,sans-serif" textAnchor="end">Balanced</text>
                <text x="141" y="133" fontSize="10.5" fill="#c9a830" fontFamily="'Fashion Fetish',Arial,sans-serif" textAnchor="end">&amp; Sweet</text>
                <circle cx="308" cy="178" r="9" fill="#8a7cbe" />
                <text x="320" y="175" fontSize="11" fill="#8a7cbe" fontFamily="'Fashion Fetish',Arial,sans-serif">Floral</text>
                <circle cx="266" cy="128" r="9" fill="#ca445f" />
                <text x="278" y="125" fontSize="11" fill="#ca445f" fontFamily="'Fashion Fetish',Arial,sans-serif">Fruity</text>
                <circle cx="222" cy="172" r="16" fill="#a33726" fillOpacity="0.12" />
                <circle cx="222" cy="172" r="10" fill="#a33726" />
                <text x="236" y="169" fontSize="12" fill="#a33726" fontFamily="'Fashion Fetish',Arial,sans-serif" fontWeight="500">You</text>
              </svg>
