    ...
    <div className="w-full min-h-screen" style={{ backgroundColor: '#f2f1ea' }}>
      ...
      <div className="pt-32 pb-16 px-8 md:px-16 max-w-[1400px] mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          <h1 className="text-5xl md:text-7xl font-normal leading-tight mb-4" style={{ color: '#b05642', fontFamily: "'Fashion Fetish', Arial, sans-serif" }}>
            Flavor Intelligence
          </h1>
                ...
                <div className="mb-8 pb-6 border-b border-stone-200">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div className="flex-1">
                      <h2 className="text-3xl font-normal" style={{ color: '#b05642', fontFamily: "'Fashion Fetish', Arial, sans-serif" }}>
                        {selectedCoffee.name}
                      </h2>
