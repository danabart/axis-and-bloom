...
// Kept for reference only — not routed. This is the original "Black Box
// Transparency" build (WHAT_WE_BUILT.md #51), recovered from git history
// before the V2 "Watch the data work" rebuild (#59) replaced TheAxis.tsx.
export default function TheAxisV1() {
  return (
