  ...
  return (
    <nav style={{
      ...
      <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none', flexShrink: 0 }}>
        ...
        <span style={{ fontFamily: "'Genova', Arial, sans-serif", color: '#9a2918', fontSize: 20, letterSpacing: '0.1em', fontWeight: 400, lineHeight: 1 }}>
          AXIS & BLOOM
        </span>
      </Link>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 20, flexShrink: 0 }}>
        ...
        {user && (
          <button
            ...
            aria-label="Sign out"
            style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontFamily: "'Genova', Arial, sans-serif", fontSize: '0.75rem', letterSpacing: '0.1em', color: '#9a2918', textTransform: 'uppercase', opacity: 0.55 }}
        ...
        >
          ...
          <span style={{
            ...
            fontFamily: "'Genova', Arial, sans-serif", fontWeight: 400,
          }}>0</span>
        </button>
      </div>
