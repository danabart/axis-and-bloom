...
7. ✅ `campaign_funnel_v`: scans=2, unique_scanners=1, quiz_starts=1, quiz_completes=1, email_events=1, subscribers=1. `campaign_subscriber_archetype_v`: `Balanced & Sweet` → 1.
